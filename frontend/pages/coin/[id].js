...
const Coin = ({ data }) => {
  return (
    <main className="bg-slate-900 h-screen bg-gradient-to-r from-cyan-500 to-purple-500 animate-gradient-bg bg-massive overflow-hidden">
      <div className="flex">
        <Sidebar />
        <div className="mx-auto px-4 max-w-screen-xl overflow-y-scroll h-screen flex-grow scrollbar-hide flex items-center justify-center">
              ...
              <section className="flex flex-col mb-6 col-span-2 lg:col-span-2">
                ...
                <div className="flex items-center space-x-2 font-bold mb-5">
                  <span className="text-4xl md:text-6xl">
                    {ConvertCurrency(data?.market_data?.current_price?.usd)}
                  </span>
                  <span
                    className={`text-sm ${
              ...
              <aside className="col-span-1 lg:px-2">
                ...
                <div className="space-y-2 my-2">
                  <RowInfo
                    ...
                    tag={data?.links?.homepage[0].replace(urlRegex, "")}
                  />
                  <RowInfo
                    title="Explorer"
                    link={data?.links?.blockchain_site[0]}
                    tag={data?.links?.blockchain_site[0].replace(urlRegex, "")}
                  />
                  <RowInfo
                    title="Source Code"
